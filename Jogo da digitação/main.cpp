...
struct Board {
    ...
    Board(sf::RenderWindow& window) : window{window}, pencil{window} {
        bubbles.push+back(Bubble(100, 100, 'A', 1));
        bubbles.push+back(Bubble(200, 100, 'B', 2));
        bubbles.push+back(Bubble(300, 100, 'C', 3));
    }
    ...
    void add_new_bubble(){
        ...
        bubbles.push_back(Bubbles(x, y, letter, speed));
    }
